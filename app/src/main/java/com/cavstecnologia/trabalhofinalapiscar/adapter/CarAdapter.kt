...
class CarAdapter(private val cars: List<Car>, private val carClickListener: (Car) -> Unit): RecyclerView.Adapter<CarAdapter.CarViewHolder>() {
    ...
    override fun onBindViewHolder(holder: CarAdapter.CarViewHolder, position: Int) {
        ...
        holder.model.text = car.value.model;
        holder.year.text = car.value.year;
        holder.license.text = car.value.license;
